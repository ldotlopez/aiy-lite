...
_SERVERBOUND = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="stream_control",
            full_name="ServerBound.stream_control",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_STREAMCONTROL = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="enabled",
            full_name="StreamControl.enabled",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
_CLIENTBOUND = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="timestamp_us",
            full_name="ClientBound.timestamp_us",
            index=4,
            number=10,
            type=4,
            cpp_type=4,
...
_SERVERBOUND.fields_by_name[
    "stream_control"
].containing_oneof = _SERVERBOUND.oneofs_by_name["message"]
...
_CLIENTBOUND.fields_by_name["start"].containing_oneof = _CLIENTBOUND.oneofs_by_name[
    "message"
]
_CLIENTBOUND.oneofs_by_name["message"].fields.append(
    _CLIENTBOUND.fields_by_name["stop"]
)
_CLIENTBOUND.fields_by_name["stop"].containing_oneof = _CLIENTBOUND.oneofs_by_name[
    "message"
]
_CLIENTBOUND.oneofs_by_name["message"].fields.append(
    _CLIENTBOUND.fields_by_name["video"]
)
_CLIENTBOUND.fields_by_name["video"].containing_oneof = _CLIENTBOUND.oneofs_by_name[
    "message"
]
_CLIENTBOUND.oneofs_by_name["message"].fields.append(
    _CLIENTBOUND.fields_by_name["overlay"]
)
_CLIENTBOUND.fields_by_name["overlay"].containing_oneof = _CLIENTBOUND.oneofs_by_name[
    "message"
]
...
ServerBound = _reflection.GeneratedProtocolMessageType(
    "ServerBound",
    (_message.Message,),
    dict(
...
StreamControl = _reflection.GeneratedProtocolMessageType(
    "StreamControl",
    (_message.Message,),
    dict(
...
ClientBound = _reflection.GeneratedProtocolMessageType(
    "ClientBound",
    (_message.Message,),
    dict(
...
Overlay = _reflection.GeneratedProtocolMessageType(
    "Overlay",
    (_message.Message,),
    dict(
        DESCRIPTOR=_OVERLAY,
